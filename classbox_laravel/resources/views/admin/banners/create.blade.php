...
@section('page-title', 'Crear Banner / Slider de Portada')
    ...
    <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-5">
            <h3 class="font-bold text-slate-800 text-sm border-b border-slate-100 pb-3 flex items-center gap-2">
                <i class="fa-solid fa-panorama text-teal-600"></i> Información del Banner
            </h3>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                    <label class="block text-xs font-semibold text-slate-700 mb-1">Título Principal (Encabezado)</label>
                    <input type="text" name="title" value="{{ old('title') }}" placeholder="Ej: Especialízate en el Área de la Salud"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="subtitle" rows="2" placeholder="Texto descriptivo o beneficio destacado..."
                              class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 focus:ring-2 focus:ring-teal-500 transition">{{ old('subtitle') }}</textarea>
                </div>

                <!-- Desktop Image -->
                <div class="md:col-span-2">
                    <label class="block text-xs font-semibold text-slate-700 mb-1">Imagen de Escritorio / PC <span class="text-rose-500">*</span> (Recomendado 1920x600 o similar)</label>
                    <div class="flex items-center gap-4">
                        <div id="desktop_preview_box" class="hidden w-28 h-14 rounded-xl border border-slate-200 overflow-hidden bg-slate-100 shrink-0">
                            <img id="desktop_preview" src="#" alt="Preview" class="w-full h-full object-cover">
                        </div>
                        <input type="file" name="image" id="desktop_image_input" required accept="image/*"
                ...
                <!-- Mobile Image -->
                <div class="md:col-span-2">
                    <label class="block text-xs font-semibold text-slate-700 mb-1">Imagen Móvil Opcional (Recomendado 800x800 o vertical)</label>
                    <div class="flex items-center gap-4">
                        <div id="mobile_preview_box" class="hidden w-14 h-14 rounded-xl border border-slate-200 overflow-hidden bg-slate-100 shrink-0">
                            <img id="mobile_preview" src="#" alt="Preview" class="w-full h-full object-cover">
                        </div>
                ...
                <div>
                    ...
                    <input type="text" name="button_text" value="{{ old('button_text') }}" placeholder="Ej: Conoce nuestros cursos"
                ...
                <div>
                    ...
                    <input type="text" name="button_url" value="{{ old('button_url') }}" placeholder="Ej: /curso/1 o https://..."
                           class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 focus:ring-2 focus:ring-teal-500">
                </div>
                ...
                <div class="md:col-span-2 pt-3 border-t border-slate-100">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        ...
                        <label class="relative flex flex-col p-3 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white cursor-pointer transition text-center group has-[:checked]:border-teal-500 has-[:checked]:bg-teal-50/40 has-[:checked]:ring-2 has-[:checked]:ring-teal-500/20">
                            <input type="radio" name="overlay_style" value="none" {{ old('overlay_style') == 'none' ? 'checked' : '' }} class="sr-only">
                        ...
                        <label class="relative flex flex-col p-3 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white cursor-pointer transition text-center group has-[:checked]:border-teal-500 has-[:checked]:bg-teal-50/40 has-[:checked]:ring-2 has-[:checked]:ring-teal-500/20">
                            <input type="radio" name="overlay_style" value="bottom_gradient_soft" {{ old('overlay_style', 'bottom_gradient_soft') == 'bottom_gradient_soft' ? 'checked' : '' }} class="sr-only">
                            <div class="h-10 w-full rounded-lg border border-slate-200/80 mb-2 flex items-end justify-center pb-1 text-slate-800 text-[9px] font-bold shadow-inner" style="background: linear-gradient(to top, rgba(15,23,42,0.45) 0%, rgba(15,23,42,0.15) 20%, #ffffff 40%, #ffffff 100%);">Suave (35%)</div>
                        ...
                        <label class="relative flex flex-col p-3 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white cursor-pointer transition text-center group has-[:checked]:border-teal-500 has-[:checked]:bg-teal-50/40 has-[:checked]:ring-2 has-[:checked]:ring-teal-500/20">
                            ...
                            <div class="h-10 w-full rounded-lg border border-slate-200/80 mb-2 flex items-end justify-center pb-1 text-white text-[9px] font-bold shadow-inner" style="background: linear-gradient(to top, rgba(15,23,42,0.78) 0%, rgba(15,23,42,0.30) 22%, #ffffff 40%, #ffffff 100%);">Medio (70%)</div>
                        ...
                        <label class="relative flex flex-col p-3 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white cursor-pointer transition text-center group has-[:checked]:border-teal-500 has-[:checked]:bg-teal-50/40 has-[:checked]:ring-2 has-[:checked]:ring-teal-500/20">
                            ...
                            <div class="h-10 w-full rounded-lg border border-slate-200/80 mb-2 flex items-end justify-center pb-1 text-white text-[9px] font-bold shadow-inner" style="background: linear-gradient(to top, rgba(15,23,42,0.95) 0%, rgba(15,23,42,0.45) 24%, #ffffff 40%, #ffffff 100%);">Fuerte (95%)</div>
                        ...
                        <!-- 5. Gradiente Lateral -->
                        <label class="relative flex flex-col p-3 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white cursor-pointer transition text-center group has-[:checked]:border-teal-500 has-[:checked]:bg-teal-50/40 has-[:checked]:ring-2 has-[:checked]:ring-teal-500/20">
                            <input type="radio" name="overlay_style" value="left_gradient" {{ old('overlay_style') == 'left_gradient' ? 'checked' : '' }} class="sr-only">
                        ...
                        <!-- 6. Glassmorphism -->
                        <label class="relative flex flex-col p-3 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white cursor-pointer transition text-center group has-[:checked]:border-teal-500 has-[:checked]:bg-teal-50/40 has-[:checked]:ring-2 has-[:checked]:ring-teal-500/20">
                            <input type="radio" name="overlay_style" value="glass_card" {{ old('overlay_style') == 'glass_card' ? 'checked' : '' }} class="sr-only">
                        ...
                        <!-- 7. Sombra Completa -->
                        <label class="relative flex flex-col p-3 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white cursor-pointer transition text-center group has-[:checked]:border-teal-500 has-[:checked]:bg-teal-50/40 has-[:checked]:ring-2 has-[:checked]:ring-teal-500/20">
                            <input type="radio" name="overlay_style" value="full_dark" {{ old('overlay_style') == 'full_dark' ? 'checked' : '' }} class="sr-only">
                        ...
                        <!-- 8. Filtro de Marca -->
                        <label class="relative flex flex-col p-3 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white cursor-pointer transition text-center group has-[:checked]:border-teal-500 has-[:checked]:bg-teal-50/40 has-[:checked]:ring-2 has-[:checked]:ring-teal-500/20">
                            <input type="radio" name="overlay_style" value="brand_tint" {{ old('overlay_style') == 'brand_tint' ? 'checked' : '' }} class="sr-only">
                ...
                <div class="md:col-span-2 pt-3 border-t border-slate-100 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3">
                    <div>
                        ...
                        <select name="content_alignment" class="w-full px-2.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800">
                            <option value="left" {{ old('content_alignment') == 'left' ? 'selected' : '' }}>⬅️ Izquierda</option>
                            <option value="center" {{ old('content_alignment') == 'center' ? 'selected' : '' }}>↔️ Centro</option>
                            <option value="right" {{ old('content_alignment') == 'right' ? 'selected' : '' }}>➡️ Derecha</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="content_vertical_alignment" class="w-full px-2.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800">
                            <option value="top" {{ old('content_vertical_alignment') == 'top' ? 'selected' : '' }}>⬆️ Superior (Arriba)</option>
                            <option value="center" {{ old('content_vertical_alignment', 'center') == 'center' ? 'selected' : '' }}>⏺️ Medio (Centrado)</option>
                            <option value="bottom" {{ old('content_vertical_alignment') == 'bottom' ? 'selected' : '' }}>⬇️ Inferior (Abajo)</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="title_size" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800">
                            <option value="sm" {{ old('title_size') == 'sm' ? 'selected' : '' }}>Pequeño (32px)</option>
                            <option value="md" {{ old('title_size') == 'md' ? 'selected' : '' }}>Mediano (42px)</option>
                            <option value="lg" {{ old('title_size', 'lg') == 'lg' ? 'selected' : '' }}>Grande (54px)</option>
                            <option value="xl" {{ old('title_size') == 'xl' ? 'selected' : '' }}>Gigante (64px)</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="title_weight" class="w-full px-2.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800">
                            <option value="light" {{ old('title_weight', 'light') == 'light' ? 'selected' : '' }}>🪶 Delgado / Fino (300)</option>
                            <option value="normal" {{ old('title_weight') == 'normal' ? 'selected' : '' }}>📄 Normal (400)</option>
                            <option value="bold" {{ old('title_weight') == 'bold' ? 'selected' : '' }}>💪 Grueso (700)</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="font_family" class="w-full px-2.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800">
                            <option value="roboto" {{ old('font_family', 'roboto') == 'roboto' ? 'selected' : '' }}>✨ Roboto (Fina)</option>
                            <option value="inter" {{ old('font_family') == 'inter' ? 'selected' : '' }}>Inter</option>
                            <option value="heebo" {{ old('font_family') == 'heebo' ? 'selected' : '' }}>Heebo</option>
                            <option value="nunito" {{ old('font_family') == 'nunito' ? 'selected' : '' }}>Nunito</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            <input type="color" value="{{ old('title_color', '#334155') }}" oninput="this.nextElementSibling.value = this.value" class="w-8 h-8 rounded border cursor-pointer p-0.5 bg-white">
                            <input type="text" name="title_color" value="{{ old('title_color', '#334155') }}" oninput="this.previousElementSibling.value = this.value" class="w-full px-2 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-mono">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            <input type="color" value="{{ old('subtitle_color', '#06BBCC') }}" oninput="this.nextElementSibling.value = this.value" class="w-8 h-8 rounded border cursor-pointer p-0.5 bg-white">
                            <input type="text" name="subtitle_color" value="{{ old('subtitle_color', '#06BBCC') }}" oninput="this.previousElementSibling.value = this.value" class="w-full px-2 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-mono">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <select name="button_style" class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800">
                        <option value="text_link" {{ old('button_style', 'text_link') == 'text_link' ? 'selected' : '' }}>🔗 Enlace Sutil con Flecha (ej: Quiero saber más →)</option>
                        <option value="primary" {{ old('button_style') == 'primary' ? 'selected' : '' }}>🔘 Botón Color Primario</option>
                        <option value="white" {{ old('button_style') == 'white' ? 'selected' : '' }}>🔘 Botón Blanco</option>
                        <option value="dark" {{ old('button_style') == 'dark' ? 'selected' : '' }}>🔘 Botón Oscuro</option>
                        <option value="outline" {{ old('button_style') == 'outline' ? 'selected' : '' }}>🔘 Botón Contorno</option>
                    </select>
                </div>
                ...
                <div class="md:col-span-2 pt-3 border-t border-slate-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <label class="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white cursor-pointer transition">
                            <input type="checkbox" name="show_subtitle" value="1" {{ old('show_subtitle', true) ? 'checked' : '' }} class="rounded text-teal-600 focus:ring-teal-500">
                            <div>
                        ...
                        <label class="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white cursor-pointer transition">
                            <input type="checkbox" name="show_title" value="1" {{ old('show_title', true) ? 'checked' : '' }} class="rounded text-teal-600 focus:ring-teal-500">
                            <div>
                        ...
                        <label class="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white cursor-pointer transition">
                            <input type="checkbox" name="show_button" value="1" {{ old('show_button', true) ? 'checked' : '' }} class="rounded text-teal-600 focus:ring-teal-500">
                            <div>
        ...
        <div class="flex items-center justify-end gap-3">
            ...
            <button type="submit" class="px-6 py-2.5 bg-teal-600 hover:bg-teal-700 text-white rounded-xl text-xs font-bold shadow-lg shadow-teal-600/30 transition flex items-center gap-2">
                <i class="fa-solid fa-cloud-arrow-up"></i> Guardar Banner
            </button>
        </div>
    </form>
</div>
