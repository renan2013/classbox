                            ...
                            <div class="position-relative overflow-hidden course-img-wrapper" style="height: 220px; background: #f8fafc;">
                                ...
                                <div class="position-absolute top-0 start-0 m-3 z-index-2">
                                    <span class="badge bg-white text-dark shadow-sm px-3 py-2 rounded-pill fw-semibold border" style="font-size: 0.78rem;">
                                        <i class="fa fa-graduation-cap text-primary me-1"></i> {{ $category->name }}
                                    </span>
                                </div>
                            </div>
            ...
            @empty
                <div class="col-12 text-center py-5">
                    <div class="bg-light p-5 rounded-4 shadow-sm border">
                        ...
                        <h4 class="fw-bold">Próximamente más programas</h4>
                        <p class="text-muted">Actualmente estamos actualizando los cursos de esta categoría. ¡Vuelve a consultar pronto!</p>
                        <a href="{{ route('site.home') }}" class="btn btn-primary rounded-pill px-4 mt-3">Volver al Inicio</a>
                    </div>
                </div>
            @endforelse
        </div>
